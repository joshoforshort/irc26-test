          ...
          <div className="mx-auto max-w-2xl bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl px-6 sm:px-8 py-8 border border-white/50">
            ...
            <div className="mx-auto max-w-[68ch] text-[16px] leading-6 space-y-5 text-center font-arial-rounded font-bold">
              ...
              <div>
                ...
                <p className="leading-relaxed mt-1 text-center" style={{ fontFamily: '"Arial Rounded MT Bold", "Helvetica Rounded", Arial, sans-serif' }}>Each CO can hide up to 10 caches. If you would like to hide more than 10, please contact beautifulsky13 with your idea.</p>
              </div>
